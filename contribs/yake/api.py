...
YAKE_HOST = os.getenv("YAKE_HOST", "127.0.0.1")
YAKE_PORT = os.getenv("YAKE_PORT", 5005)
YAKE_DEBUG = os.getenv("YAKE_DEBUG", False)
...
if __name__ == "__main__":
    app.run(host=YAKE_HOST, port=YAKE_PORT debug=YAKE_DEBUG)
